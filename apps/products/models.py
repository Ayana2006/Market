...
class Product(models.Model):
    ...
    PRODUCT_STATUS = (('Активный','Активный'),('На модерации','На модерации'),('Не активный','Не активный'), ('Откланён','Откланён'))
    product_status = models.CharField(choices=PRODUCT_STATUS, default='Активный', max_length=35)
